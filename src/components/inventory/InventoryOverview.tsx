          ...
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className={`text-2xl font-bold ${analytics.lowStockItems > 0 ? 'text-orange-500' : 'text-success'}`}>
                  {analytics.lowStockItems}
                </p>
                <p className="text-xs text-red-500">{analytics.criticalStockItems} critical</p>
              </div>
              <AlertTriangle className={`h-8 w-8 ${analytics.lowStockItems > 0 ? 'text-orange-500' : 'text-success'}`} />
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className={`text-2xl font-bold ${profitColor}`}>{analytics.profitMargin}%</p>
          ...
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className={`text-2xl font-bold ${turnoverColor}`}>{analytics.turnoverRate}x</p>
              ...
              <div key={item.item.id} className="flex items-center justify-between p-3 bg-background/30 rounded-lg border border-border/50">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">{item.item.brand}</p>
                  </div>
                </div>
        ...
        <CardContent>
          <div className="space-y-4">
            {analytics.supplierPerformance.map((perf) => (
              <div key={perf.supplier.id} className="flex items-center justify-between p-3 bg-background/30 rounded-lg border border-border/50">
                <div className="flex items-center gap-3">
                  <div>
